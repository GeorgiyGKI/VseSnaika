...
export const voiceOptions = {
    // Male voices
    dave: { id: 'CYw3kZ02Hs0563khs1Fj', name: 'Дэйв', description: 'Молодой мужской, британский-эссекский, неформальный и разговорный' },
    daniel: { id: 'onwK4e9ZLuTAKqWW03F9', name: 'Дэниел', description: 'Мужской средних лет, британский, уверенный и теплый' },
    chris: { id: 'iP95p4xoKVk53GoZ742B', name: 'Крис', description: 'Мужской, непринужденный и дружелюбный' },
    // Female voices
    rachel: { id: '21m00Tcm4TlvDq8ikWAM', name: 'Рейчел', description: 'Молодая женская, американская, спокойная и четкая' },
    sarah: { id: 'EXAVITQu4vr4xnSDxMaL', name: 'Сара', description: 'Молодая женская, американская, мягкая и дружелюбная' },
};
