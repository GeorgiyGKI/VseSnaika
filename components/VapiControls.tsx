...
const VapiControls = ({ book }: { book: IBook }) => {
    ...
    const getStatusDisplay = () => {
        switch (status) {
            case 'connecting': return { label: 'Соединяюсь...', color: 'vapi-status-dot-connecting' };
            case 'starting': return { label: 'Начинаю...', color: 'vapi-status-dot-starting' };
            case 'listening': return { label: 'Слушаю', color: 'vapi-status-dot-listening' };
            case 'thinking': return { label: 'Думаю...', color: 'vapi-status-dot-thinking' };
            case 'speaking': return { label: 'Разговариваю', color: 'vapi-status-dot-speaking' };
            default: return { label: 'Готов', color: 'vapi-status-dot-ready' };
        }
    };
