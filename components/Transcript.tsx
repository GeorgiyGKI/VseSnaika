...
const Transcript = ({ messages, currentMessage, currentUserMessage }: TranscriptProps) => {
  ...
  if (isEmpty) {
    return (
      <div className="transcript-empty">
        ...
        <h2 className="transcript-empty-text"><b>Разговор еще не начат</b></h2>
        <p className="transcript-empty-hint">
          Нажмите на кнопку микрофона выше, чтобы начать беседу
        </p>
      </div>
    );
  }
  ...
  return (
    <div ref={scrollRef} className="transcript-messages overflow-y-auto pr-2 flex-1">
      <h1 className="text-[#3d485e] font-medium">Говорите первым, не стесняйтесь</h1>
